...
def run_commands_on_machine(m_name, machine):
    ...
    commands = [
        f'scp -i ".\\petazm42.pem" sqs_listener.py {machine}:~/',
        f'scp -i ".\\petazm42.pem" img_proc.py {machine}:~/',
    ]
...
machines = {'slave1': 'ec2-user@ec2-13-60-42-99.eu-north-1.compute.amazonaws.com',
            'slave2': 'ec2-13-60-46-173.eu-north-1.compute.amazonaws.com',
            'slave3': 'ec2-16-171-206-179.eu-north-1.compute.amazonaws.com',
}
